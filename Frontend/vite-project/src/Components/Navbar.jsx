...
function Navbar() {
    //   End of the react Hook for dark or light mode 
    // Start of react hook for sticky navbar and change in colour of navbar when scroll 
    ...
    // End of the react hook 

    
    // This is variable which store the list items 
    const navitems = (
        <>
            <li><a href='/'>Home</a></li>
        ...
        <>
            <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${sticky?"sticky-navbar shadow-md bg-base-200 duration-300 transition-all ease-in-out":""}`}>
                <div className="navbar ">
                    ...
                    {/* NavBar Starts for Medium and large Screens  */}
                    <div className="navbar-end space-x-3">
                        ...
                        {/* Here this is our Search Bar starts  */}
